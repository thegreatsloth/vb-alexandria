const buildingPlans = {
  small: {
    buttonText: "50,000 Sq. Ft. General Manufacturing",
    submitLink: "./assets/img/England-Airpark-Manufacturing-50000.pdf",
    basePrice: 3650000,
    baseTimeline: 8,
    images: {
      1: "assets/img/50000-alexandria-render1-rev.png",
      2: "assets/img/50000-alexandria-render2-rev.png",
      3: "assets/img/50000-alexandria-render3-rev.png",
      4: "assets/img/50000-alexandria-render4-rev.png",
      5: "assets/img/50000-alexandria-render5-rev.png"
    },
    selectOptions: {
      ceilingHeight: {
      ...
      crane: {
        label: "15 Ton Crane Base Structure",
        name: "crane",
        1: {
          base: true,
          label: "No (Base)",
  ...
  mid: {
    buttonText: "62,000 SQ. FT. Hangar",
    basePrice: 17250000,
    baseTimeline: 12,
    submitLink: "./assets/img/England-Airpark-Hangar-64000.pdf",
    images: {
      1: "assets/img/64000-alexandria-render2.jpg",
      2: "assets/img/64000-alexandria-render1.jpg",
      3: "assets/img/64000-alexandria-render4.jpg",
      4: "assets/img/64000-alexandria-render3.jpg"
    },
    selectOptions: {
      exteriorFinish: {
        label: "Exterior Finish Options (Metal/CMU)",
        ...
        1: {
          base: true,
          label: "Pre-Engineered Metal Panels (Base)",
          value: 0
        },
        2: {
          base: false,
    ...
    rangeSliders: {
      ...
      fabricationShop: {
        label: "Add Fabrication Shop SF",
        min: 0,
        max: 15000,
        base: 0,
        name: "fabricationShop"
      },
      painting: {
        label: "Add Painting Shop SF",
        min: 0,
        max: 64000,
        base: 0,
        name: "painting"
      ...
      airframe: {
        label: "Add Airframe/Engine/Aero Repair SF",
        min: 0,
        max: 15000,
        base: 0,
        name: "airframe"
      ...
      nondestructiveTesting: {
        label: "Add Nondestructive Testing Lab SF",
        min: 0,
        max: 15000,
        base: 0,
        name: "nondestructiveTesting"
      }
    }
  },
  large: {
    buttonText: "200,000 Sq. Ft. Regional Distribution",
    basePrice: 13600000,
    baseTimeline: 12,
    submitLink: "./assets/img/England-Airpark-Distribution-200000.pdf",
    images: {
      1: "assets/img/200000-alexandria-render1-rev.png",
      2: "assets/img/200000-alexandria-render2-rev.png",
      3: "assets/img/200000-alexandria-render3-rev.png",
      4: "assets/img/200000-alexandria-render4-rev.png",
      5: "assets/img/200000-alexandria-render5-rev.png"
    },
    selectOptions: {
      ceilingHeight: {
        label: "Ceiling Height ",
...
function destroyRebuild() {
  ...
  if (document.getElementById("officeProduction")) {
    if (targetedItemInObject == "large") {
      // set the step to 200 for the airport hangar
      document.getElementById("officeProduction").step = 200;
    } else {
...
function dockDoorsUpdate() {
  ...
  if (dockDoorsValue > 4) {
    dockDoorsPrice = (dockDoorsValue - 4) * 15000;
  } else if (dockDoorsValue < 4) {
    dockDoorsPrice = (4 - dockDoorsValue) * -15000;
  } else if (dockDoorsValue == 4) {
    dockDoorsPrice = 0;
  }
...
if (backArrow) {
  backArrow.addEventListener("click", function() {
    ...
    if (targetedItemInObject == "small" || targetedItemInObject == "large") {
      var imgNumber = parseFloat(
        currentImgSrc.charAt(currentImgSrc.length - 9)
      );
    } else if (targetedItemInObject == "mid") {
      var imgNumber = parseFloat(
        currentImgSrc.charAt(currentImgSrc.length - 5)
      );
    }
